...
public class GenerateOutputTest {
    ...
    @Test
    public void testWriteOutput() throws FileNotFoundException, UnsupportedEncodingException {
        
        String filePath = System.getProperty("user.dir") + File.separator + "STIW3054-Result" + File.separator + "Output.log";
